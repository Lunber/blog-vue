<template>
  ...
  <div class="personal-div"  :class="{'scroll-nav':scrollTop}">
    ...
    <nav>
      <span><a v-link="{ path:'/home'}">home</a></span>
      <span><a v-link="{ path:'/blog'}">blog</a></span>
      <span><a>about</a></span>
    </nav>
    <inscss></inscss>
  </div>
  <div class="router-content-div">
    <router-view style="padding-top: 2em" msg="props test" v-on:title="titleMsg" class="view" transition="test"
